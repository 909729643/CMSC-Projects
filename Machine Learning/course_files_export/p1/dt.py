...
class DT(BinaryClassifier):
    ...
    def trainDT(self, X, Y, maxDepth, used):
        ...
        if maxDepth <= 0 or len(util.uniq(Y)) <= 1:
            ...
            self.isLeaf = True    ### TODO: YOUR CODE HERE finish

            self.label  = util.mode(Y)    ### TODO: YOUR CODE HERE finish
            ...
            for d in range(D):
                ...
                leftY  = Y[X[:,d]<0.5]    ### TODO: YOUR CODE HERE finish

                rightY = Y[X[:,d]>=0.5]    ### TODO: YOUR CODE HERE finish
            ...
            if bestFeature < 0:
                ...
                self.isLeaf  = False    ### TODO: YOUR CODE HERE finish

                self.feature = bestFeature    ### TODO: YOUR CODE HERE finish
